...
class ConsolesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create console" do
    assert_difference('Console.count') do
      post consoles_url, params: { console: { description: @console.description, title: @console.title } }
    end
  ...
  test "should update console" do
    patch console_url(@console), params: { console: { description: @console.description, title: @console.title } }
